...
mkdir -p ~/.local/bin
wget -O ~/.local/bin/kvantum-theme-watcher https://raw.githubusercontent.com/Lobanokivan11/kvantum-kde-sync/refs/heads/main/kvantum-theme-watcher
chmod +x ~/.local/bin/kvantum-theme-watcher
